...
** Font Configuration
I am using the Monaco and Cantarell fonts for this configuration which will more than likely need to be installed on your machine.

#+begin_src emacs-lisp

(set-face-attribute 'default nil :font "Monaco" :height bumbler/default-font-size)
(set-face-attribute 'fixed-pitch nil :font "Cantarell" :height bumbler/default-font-size)
(set-face-attribute 'variable-pitch nil :font "Cantarell" :height bumbler/default-font-size :weight 'regular)
#+end_src

* Keybinding Configuration
** Copy & Paset with Alt+c & Alt+v
...
** Better Font Faces
The =bumbler/org-font-setup= function configures various text faces to tweak the sizes of headings and use variable width fonts in most cases so that it looks more like we're editing a document in =org-mode=.  We switch back to fixed width (monospace) fonts for code blocks and tables so that they display correctly.
